...
public class TestCircleWithStaticVariableAndMethod {
  ...
  public static void printCircle(
    ...
    // below using instance.member syntax to get static member  
    System.out.println("radius (" + c.getRadius() +
      ") and number of Circle objects (" +
      c.getNumberOfObjects() + ")");
    
    // below using classname.member syntax to get static member  
    System.out.println(" number of Circle objects (" +
      CircleWithStaticVariableAndMethod.getNumberOfObjects() + ")");
  }
}